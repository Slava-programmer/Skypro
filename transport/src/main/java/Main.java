...
public class Main {
    public static void main(String[] args) {
        ...
        lada1.setInsurance(lada1.insureCar(LocalDate.of(2015, 5, 21), 15_000, "9588550055"));
        hyundai1.setInsurance(hyundai1.insureCar(LocalDate.of(2023, 10, 1), 7_000, "0755654610"));
